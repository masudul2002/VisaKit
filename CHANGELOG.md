...
## [Milestone 01] - 2026-07-09

### Added
- Completed comprehensive engineering code audit and release readiness review.
- Created `docs/CODE_AUDIT_REPORT.md` and `docs/RELEASE_READINESS.md`.

## [1.0.1] - 2026-07-09

### Added
- Created quality assurance report `docs/REFACTOR_REPORT.md`.
- Refactored explicit `any` typings inside `profile.service.ts` and `inspector.service.ts` to strict schemas.
- Configured compiler warning ignores for explicit lock hooks in `popup/App.tsx`.
- Updated manifest version configuration to `"1.0.1"`.
