...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  return (
    <div className="w-[400px] h-[600px] bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col font-sans select-none overflow-hidden relative border border-slate-100 dark:border-slate-900 shadow-2xl">
